...
fabric-ca-client enroll -u https://admin:adminpw@ca-org1:7054 --caname ca-org1 --tls.certfiles "/data/organizations/fabric-ca/org1/tls-cert.pem"
...
fabric-ca-client register --caname ca-org1 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "/data/organizations/fabric-ca/org1/tls-cert.pem"



fabric-ca-client register --caname ca-org1 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "/data/organizations/fabric-ca/org1/tls-cert.pem"




fabric-ca-client register --caname ca-org1 --id.name org1admin --id.secret org1adminpw --id.type admin --tls.certfiles "/data/organizations/fabric-ca/org1/tls-cert.pem"



fabric-ca-client enroll -u https://peer0:peer0pw@ca-org1:7054 --caname ca-org1 -M "/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp" --csr.hosts peer0.org1.example.com --csr.hosts  peer0-org1 --tls.certfiles "/data/organizations/fabric-ca/org1/tls-cert.pem"
...
fabric-ca-client enroll -u https://user1:user1pw@ca-org1:7054 --caname ca-org1 -M "/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp" --tls.certfiles "/data/organizations/fabric-ca/org1/tls-cert.pem"
...
fabric-ca-client enroll -u https://org1admin:org1adminpw@ca-org1:7054 --caname ca-org1 -M "/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" --tls.certfiles "/data/organizations/fabric-ca/org1/tls-cert.pem"
