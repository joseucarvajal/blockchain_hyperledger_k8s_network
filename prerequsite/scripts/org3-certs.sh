...
fabric-ca-client enroll -u https://admin:adminpw@ca-org3:9054 --caname ca-org3 --tls.certfiles "/data/organizations/fabric-ca/org3/tls-cert.pem"
...
fabric-ca-client register --caname ca-org3 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "/data/organizations/fabric-ca/org3/tls-cert.pem"

fabric-ca-client register --caname ca-org3 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "/data/organizations/fabric-ca/org3/tls-cert.pem"

fabric-ca-client register --caname ca-org3 --id.name org3admin --id.secret org3adminpw --id.type admin --tls.certfiles "/data/organizations/fabric-ca/org3/tls-cert.pem"

fabric-ca-client enroll -u https://peer0:peer0pw@ca-org3:9054 --caname ca-org3 -M "/organizations/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/msp" --csr.hosts peer0.org3.example.com --csr.hosts  peer0-org3 --tls.certfiles "/data/organizations/fabric-ca/org3/tls-cert.pem"
...
fabric-ca-client enroll -u https://user1:user1pw@ca-org3:9054 --caname ca-org3 -M "/organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp" --tls.certfiles "/data/organizations/fabric-ca/org3/tls-cert.pem"
...
fabric-ca-client enroll -u https://org3admin:org3adminpw@ca-org3:9054 --caname ca-org3 -M "/organizations/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp" --tls.certfiles "/data/organizations/fabric-ca/org3/tls-cert.pem"
