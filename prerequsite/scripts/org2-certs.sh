...
fabric-ca-client enroll -u https://admin:adminpw@ca-org2:8054 --caname ca-org2 --tls.certfiles "/data/organizations/fabric-ca/org2/tls-cert.pem"
...
fabric-ca-client register --caname ca-org2 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "/data/organizations/fabric-ca/org2/tls-cert.pem"

fabric-ca-client register --caname ca-org2 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "/data/organizations/fabric-ca/org2/tls-cert.pem"

fabric-ca-client register --caname ca-org2 --id.name org2admin --id.secret org2adminpw --id.type admin --tls.certfiles "/data/organizations/fabric-ca/org2/tls-cert.pem"

fabric-ca-client enroll -u https://peer0:peer0pw@ca-org2:8054 --caname ca-org2 -M "/organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/msp" --csr.hosts peer0.org2.example.com --csr.hosts  peer0-org2 --tls.certfiles "/data/organizations/fabric-ca/org2/tls-cert.pem"
...
fabric-ca-client enroll -u https://user1:user1pw@ca-org2:8054 --caname ca-org2 -M "/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp" --tls.certfiles "/data/organizations/fabric-ca/org2/tls-cert.pem"
...
fabric-ca-client enroll -u https://org2admin:org2adminpw@ca-org2:8054 --caname ca-org2 -M "/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp" --tls.certfiles "/data/organizations/fabric-ca/org2/tls-cert.pem"
